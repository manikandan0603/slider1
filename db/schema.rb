...
ActiveRecord::Schema.define(version: 20160426061119) do
  ...
  create_table "community_plans", force: :cascade do |t|
    t.integer  "community_id", limit: 4,             null: false
    t.integer  "plan_level",   limit: 4, default: 0, null: false
    t.datetime "expires_at"
    t.datetime "created_at",                         null: false
    t.datetime "updated_at",                         null: false
  end

  add_index "community_plans", ["community_id"], name: "index_community_plans_on_community_id", using: :btree
  ...
  create_table "listings", force: :cascade do |t|
    ...
    t.string   "listing_category",                limit: 255
  ...
  add_index "listings", ["listing_type_old"], name: "index_listings_on_listing_type", using: :btree
  ...
  create_table "readings", force: :cascade do |t|
    ...
    t.integer  "main_slider_values", limit: 4
    t.integer  "s1",                 limit: 4
    t.integer  "s2",                 limit: 4
    t.integer  "s3",                 limit: 4
    t.integer  "s4",                 limit: 4
    t.integer  "s5",                 limit: 4
    t.integer  "s6",                 limit: 4
    t.integer  "s7",                 limit: 4
    t.integer  "s8",                 limit: 4
    t.integer  "s9",                 limit: 4
    t.integer  "s10",                limit: 4
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
  end
